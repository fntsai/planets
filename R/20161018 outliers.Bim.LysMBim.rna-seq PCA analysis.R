...
setwd("/Users/FuNien/Documents/2016_RNA-seq/comparisons/20161015/Bim.LysMBim/outliers")
...
counts_file <- "trimmed.outliers.BimLysMBim.normCounts.txt"
...
outputname <- "outliers.PCA.Bim.LysMBim"
