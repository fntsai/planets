...
setwd("/Users/FuNien/Documents/2016_RNA-seq/comparisons/20161031 BimvsLysMBim PCA")
...
counts_file <- "3.n.8mo.htseq.normCounts.txt"
...
outputname <- "3n8mo.PCA.Bim.LysMBim"
